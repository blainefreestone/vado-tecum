...
"{generated_question} \n" \
"The student's answer is not completely correct because: {comment}. " \
...
"Do not simply translate the reason the student's answer is incorrect, provide feedback on how to improve."

class Correctness(BaseModel):
    correct: bool = Field(..., description="Is the answer correct based on the information in the passage?")
    comment: str = Field(..., description="One sentence explaining the grade given. If the answer is incorrect, explain why. ")
